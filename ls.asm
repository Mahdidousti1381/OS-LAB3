...
00000613 <set_process_deadline>:
SYSCALL(set_process_deadline)
 613:	b8 16 00 00 00       	mov    $0x16,%eax
 618:	cd 40                	int    $0x40
 61a:	c3                   	ret

0000061b <change_sched_level>:
SYSCALL(change_sched_level)
 61b:	b8 17 00 00 00       	mov    $0x17,%eax
 620:	cd 40                	int    $0x40
 622:	c3                   	ret

00000623 <print_sched_info>:
SYSCALL(print_sched_info)
 623:	b8 19 00 00 00       	mov    $0x19,%eax
 628:	cd 40                	int    $0x40
 62a:	c3                   	ret

0000062b <update_wait_time>:
SYSCALL(update_wait_time)
 62b:	b8 1a 00 00 00       	mov    $0x1a,%eax
 630:	cd 40                	int    $0x40
 632:	c3                   	ret

00000633 <is_higher_waiting>:
SYSCALL(is_higher_waiting)
 633:	b8 1b 00 00 00       	mov    $0x1b,%eax
 638:	cd 40                	int    $0x40
 63a:	c3                   	ret

0000063b <set_deadline_for_process>:
SYSCALL(set_deadline_for_process)
 63b:	b8 1c 00 00 00       	mov    $0x1c,%eax
 640:	cd 40                	int    $0x40
 642:	c3                   	ret
