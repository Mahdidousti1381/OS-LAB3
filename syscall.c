...
extern int sys_is_higher_waiting(void);
extern int sys_set_deadline_for_process(void);
...
[SYS_is_higher_waiting] sys_is_higher_waiting,
[SYS_set_deadline_for_process] sys_set_deadline_for_process,
