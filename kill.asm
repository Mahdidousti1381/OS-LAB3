 ...
 388:	89 d1                	mov    %edx,%ecx
{
 ...
 3bb:	0f b6 92 9c 07 00 00 	movzbl 0x79c(%edx),%edx
 ...
 429:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 494:	ff 24 85 44 07 00 00 	jmp    *0x744(,%eax,4)
 ...
 5b1:	a1 48 0a 00 00       	mov    0xa48,%eax
{
 ...
 5ef:	5b                   	pop    %ebx
  freep = p;
 5f0:	a3 48 0a 00 00       	mov    %eax,0xa48
}
 5f5:	5e                   	pop    %esi
 5f6:	5f                   	pop    %edi
 5f7:	5d                   	pop    %ebp
 ...
 606:	72 ce                	jb     5d6 <free+0x26>
{
 ...
 627:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 62a:	a3 48 0a 00 00       	mov    %eax,0xa48
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 68b:	3b 05 48 0a 00 00    	cmp    0xa48,%eax
