...
int main()
{
  ...
  20:	6a 01                	push   $0x1
  22:	50                   	push   %eax
  23:	e8 d3 03 00 00       	call   3fb <change_sched_level>
    for (int i = 0; i < N; i++)
  28:	83 c4 10             	add    $0x10,%esp
  2b:	83 eb 01             	sub    $0x1,%ebx
  2e:	75 e4                	jne    14 <main+0x14>
    }

    for (int i = 0; i < N; i++)
        wait();
  30:	e8 26 03 00 00       	call   35b <wait>
  35:	e8 21 03 00 00       	call   35b <wait>
  3a:	e8 1c 03 00 00       	call   35b <wait>
  3f:	e8 17 03 00 00       	call   35b <wait>
  44:	e8 12 03 00 00       	call   35b <wait>

    busywork(10 , 85);
  49:	83 ec 08             	sub    $0x8,%esp
  4c:	6a 55                	push   $0x55
  4e:	6a 0a                	push   $0xa
  50:	e8 3b 00 00 00       	call   90 <busywork>
    print_sched_info();
  55:	e8 a9 03 00 00       	call   403 <print_sched_info>
    printf(1, "RR test complete\n");
  5a:	58                   	pop    %eax
  5b:	5a                   	pop    %edx
  5c:	68 f1 07 00 00       	push   $0x7f1
  61:	6a 01                	push   $0x1
  63:	e8 68 04 00 00       	call   4d0 <printf>
    exit();
  68:	e8 e6 02 00 00       	call   353 <exit>
            busywork(5,getpid());
  6d:	e8 61 03 00 00       	call   3d3 <getpid>
  72:	51                   	push   %ecx
  73:	51                   	push   %ecx
  74:	50                   	push   %eax
  75:	6a 05                	push   $0x5
  77:	e8 14 00 00 00       	call   90 <busywork>
            print_sched_info(); // Watch RR rotation, quantum, etc.
  7c:	e8 82 03 00 00       	call   403 <print_sched_info>
            exit();
  81:	e8 cd 02 00 00       	call   353 <exit>
  86:	66 90                	xchg   %ax,%ax
  88:	66 90                	xchg   %ax,%ax
  8a:	66 90                	xchg   %ax,%ax
  8c:	66 90                	xchg   %ax,%ax
...
00000090 <busywork>:
{
  ...
  93:	57                   	push   %edi
  94:	31 ff                	xor    %edi,%edi
  96:	56                   	push   %esi
  97:	be ab aa aa aa       	mov    $0xaaaaaaab,%esi
  9c:	53                   	push   %ebx
  9d:	83 ec 2c             	sub    $0x2c,%esp
  a0:	8b 5d 08             	mov    0x8(%ebp),%ebx
    volatile int x = 0;
  a3:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
    for (int k = 0; k < ticks; k++)
  aa:	85 db                	test   %ebx,%ebx
  ac:	7e 38                	jle    e6 <busywork+0x56>
        for (int i = 0; i < LOOP; i++)
  ae:	89 7d d4             	mov    %edi,-0x2c(%ebp)
  b1:	31 c9                	xor    %ecx,%ecx
  b3:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
            x += i % 3;
  b8:	89 c8                	mov    %ecx,%eax
  ba:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  bd:	f7 e6                	mul    %esi
  bf:	89 d0                	mov    %edx,%eax
  c1:	83 e2 fe             	and    $0xfffffffe,%edx
  c4:	d1 e8                	shr    $1,%eax
  c6:	01 c2                	add    %eax,%edx
  c8:	89 c8                	mov    %ecx,%eax
        for (int i = 0; i < LOOP; i++)
  ca:	83 c1 01             	add    $0x1,%ecx
            x += i % 3;
  cd:	29 d0                	sub    %edx,%eax
  cf:	01 f8                	add    %edi,%eax
  d1:	89 45 e4             	mov    %eax,-0x1c(%ebp)
        for (int i = 0; i < LOOP; i++)
  d4:	81 f9 80 96 98 00    	cmp    $0x989680,%ecx
  da:	75 dc                	jne    b8 <busywork+0x28>
    for (int k = 0; k < ticks; k++)
  dc:	8b 7d d4             	mov    -0x2c(%ebp),%edi
  df:	83 c7 01             	add    $0x1,%edi
  e2:	39 fb                	cmp    %edi,%ebx
  e4:	75 c8                	jne    ae <busywork+0x1e>
    printf(1, "  busyjob %d finished. \n", n);
  e6:	83 ec 04             	sub    $0x4,%esp
  e9:	ff 75 0c             	push   0xc(%ebp)
  ec:	68 d8 07 00 00       	push   $0x7d8
  f1:	6a 01                	push   $0x1
  f3:	e8 d8 03 00 00       	call   4d0 <printf>
}
  f8:	83 c4 10             	add    $0x10,%esp
  fb:	8d 65 f4             	lea    -0xc(%ebp),%esp
  fe:	5b                   	pop    %ebx
  ff:	5e                   	pop    %esi
 100:	5f                   	pop    %edi
 101:	5d                   	pop    %ebp
 ...
 438:	89 d1                	mov    %edx,%ecx
{
 ...
 46b:	0f b6 92 64 08 00 00 	movzbl 0x864(%edx),%edx
 ...
 4d9:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 544:	ff 24 85 0c 08 00 00 	jmp    *0x80c(,%eax,4)
 ...
 650:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 655:	bb 03 08 00 00       	mov    $0x803,%ebx
 ...
 661:	a1 34 0b 00 00       	mov    0xb34,%eax
{
 ...
 69f:	5b                   	pop    %ebx
  freep = p;
 6a0:	a3 34 0b 00 00       	mov    %eax,0xb34
}
 6a5:	5e                   	pop    %esi
 6a6:	5f                   	pop    %edi
 6a7:	5d                   	pop    %ebp
 ...
 6b6:	72 ce                	jb     686 <free+0x26>
{
 ...
 6d7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6da:	a3 34 0b 00 00       	mov    %eax,0xb34
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6f9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6fc:	8b 15 34 0b 00 00    	mov    0xb34,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 73b:	3b 05 34 0b 00 00    	cmp    0xb34,%eax
 ...
 75e:	e8 fd fe ff ff       	call   660 <free>
  return freep;
 763:	8b 15 34 0b 00 00    	mov    0xb34,%edx
 ...
 7a7:	0b 00 00 
    base.s.size = 0;
 7aa:	b8 38 0b 00 00       	mov    $0xb38,%eax
    base.s.ptr = freep = prevp = &base;
